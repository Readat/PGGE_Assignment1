...
public class PlayerMovement : MonoBehaviour
{
    ...
    #endif
        //gets the key inputs and change their respective variable booleans to play the animations
        speed = mWalkSpeed;
    ...
    public void Move()
    {
        //checks if the player is crouching or blocking, and if they are prevent movement
        if (crouch) return;
        if (block) return;
    ...
    void Crouch()
    {
        //plays the crouch animation and lowers the camera height
