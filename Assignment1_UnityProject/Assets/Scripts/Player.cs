...
public class Player : MonoBehaviour
{
  ...
  public void Aim()
  {
    ...
    Vector3 dir = -mGunTransform.up.normalized;
    // Find gunpoint as mentioned in the worksheet.
    // Vector3 gunpoint = mGunTransform.transform.position +
    //                    dir * 1.2f -
    //                    mGunTransform.forward * 0.1f;

    Vector3 gunpoint = new Vector3(transform.position.x, mGunTransform.transform.position.y, transform.position.z);
  ...
  public void FireBullet()
  {
    ...
    Vector3 dir = -mGunTransform.up.normalized;
    Vector3 firePoint = new Vector3(transform.position.x, mGunTransform.transform.position.y, transform.position.z);
